...
- **`NEW`** → `$ARGUMENTS` 를 기능 설명으로 보고 kebab-case slug로 변환한다.
  ...
  - 변환된 slug를 사용자에게 확인한다. > `docs/features/user-login/design.md` 에 디자인 산출물을 누적할게요. 맞나요?
...
>
> 승인 시 4단계로 진행한다. 거부하거나 수정을 요청하면 멈춘다. 상단 체크박스 “3 계획 리뷰” 를 체크하고 사용자 승인 항목을 갱신한다.
>
> ### 4단계 — HTML (프로덕션 HTML/CSS 구현)
>
...
>
> 구현 준비가 되면 /project-implement {FEATURE_SLUG} 를 실행하세요.
> ```
>
